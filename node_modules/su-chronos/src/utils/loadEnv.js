...
import parser from "./chronosfileParser.js";
import { readFileSync } from "node:fs";
import { SYSTEM } from "../var/system.js";

/** 
 * A function that takes the `Chronosfile` file and parses its contents to the process
...
export default function loadEnv(path) {
    ...
    chronosfile = parser(chronosfile); 

    const fileKeys = Object.keys(chronosfile);
